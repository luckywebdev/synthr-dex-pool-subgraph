...
import { ADDRESS_ZERO, factoryContract, ZERO_BD, ZERO_BI, convertTokenToDecimal, loadTransaction, SyETH_ETH_POOL, USDC_ETH_POOL } from './helpers'
...
export function handleIncreaseLiquidity(event: IncreaseLiquidity): void {
  ...
  // temp fix
  if (Address.fromString(position.pool) != Address.fromHexString(SyETH_ETH_POOL) && Address.fromString(position.pool) != Address.fromHexString(USDC_ETH_POOL)) {
    return
  }
