...
export class PriceOracle__getRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PriceOracle__latestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PriceOracle__proposedGetRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PriceOracle__proposedLatestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PriceOracle extends ethereum.SmartContract {
  ...
  getRoundData(_roundId: BigInt): PriceOracle__getRoundDataResult {
    let result = super.call(
      "getRoundData",
    ...
    return new PriceOracle__getRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getRoundData(
    _roundId: BigInt
  ): ethereum.CallResult<PriceOracle__getRoundDataResult> {
    let result = super.tryCall(
      "getRoundData",
      "getRoundData(uint80):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)]
    ...
    return ethereum.CallResult.fromValue(
      new PriceOracle__getRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestRoundData(): PriceOracle__latestRoundDataResult {
    let result = super.call(
      "latestRoundData",
    ...
    return new PriceOracle__latestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_latestRoundData(): ethereum.CallResult<
    PriceOracle__latestRoundDataResult
  > {
    let result = super.tryCall(
      "latestRoundData",
      "latestRoundData():(uint80,int256,uint256,uint256,uint80)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PriceOracle__latestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  proposedGetRoundData(
    _roundId: BigInt
  ): PriceOracle__proposedGetRoundDataResult {
    let result = super.call(
      "proposedGetRoundData",
    ...
    return new PriceOracle__proposedGetRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedGetRoundData(
    _roundId: BigInt
  ): ethereum.CallResult<PriceOracle__proposedGetRoundDataResult> {
    let result = super.tryCall(
      "proposedGetRoundData",
      "proposedGetRoundData(uint80):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PriceOracle__proposedGetRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  proposedLatestRoundData(): PriceOracle__proposedLatestRoundDataResult {
    let result = super.call(
    ...
    return new PriceOracle__proposedLatestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedLatestRoundData(): ethereum.CallResult<
    PriceOracle__proposedLatestRoundDataResult
  > {
    let result = super.tryCall(
      "proposedLatestRoundData",
      "proposedLatestRoundData():(uint80,int256,uint256,uint256,uint80)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PriceOracle__proposedLatestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
